...
namespace App\Domains\Pitching\Support;

final class PitchDraftBlocks
{
     ...
     */
    public static function applyPatch(array $blocks, array $patch): array
    {
        $next = self::normalize($blocks);
        $changed = [];
     ...
     * @param  array<string, string>  $blocks
     */
    public static function toPromptSnapshot(array $blocks): string
    {
        $lines = [];
