...
| Blade layout/shell (not primary UI) | [`rules/blade-views.md`](rules/blade-views.md) |
| Environment values and application configuration | [`rules/config.md`](rules/config.md) |
| PHPUnit patterns, factories, fakes | [`rules/testing.md`](rules/testing.md) |
| Naming, helpers, file boundaries, PHP style | [`rules/style.md`](rules/style.md) |
| Services, dependencies, application structure | [`rules/architecture.md`](rules/architecture.md) |
...
- Keep database access out of Blade/Inertia views and prevent hidden N+1 queries across controllers, resources, jobs, and serialization.
